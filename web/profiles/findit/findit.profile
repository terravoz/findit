...
function findit_contact_block() {
  ...
  $block['content'] .= t('<div class="twitter-follow"><a href="https://twitter.com/FICambridge" class="twitter-follow-button" data-show-screen-name="false" data-show-count="false">Follow @FICambridge</a></div>');
  ...
  $block['content'] .= t('<div class="instagram-badge"><a href="https://www.instagram.com/finditcambridge/?ref=badge" class="ig-b- ig-b-32"><img src="//badges.instagram.com/static/images/ig-badge-32.png" alt="Instagram" /></a></div>');
