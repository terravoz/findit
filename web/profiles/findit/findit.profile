...
define('FINDIT_FIELD_PROGRAM_LOCATIONS', 'field_program_locations');
define('FINDIT_FIELD_PROGRAM_SCHEDULE', 'field_program_schedule');
define('FINDIT_FIELD_PROGRAM_TIMES', 'field_program_times');
